...
import com.dicon.bcu.chat.config.ChatConfig;
import com.dicon.bcu.chat.enums.ChatModelType;
import com.dicon.bcu.chat.listener.SSEEventSourceListener;
...
//    }
    ...
    public SseEmitter chat(ChatRequest chatRequest, SseEmitter emitter) {
        ...
        ChatModelVo chatModelVo = chatModelService.selectModelByCategory(ChatModelType.IMAGE.getCode());
        if (chatModelVo == null) {
    ...
    public String getCategory() {
        return ChatModelType.IMAGE.getCode();
    }
}
